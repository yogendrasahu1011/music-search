...
function (_Component) {
  ...
  function Search() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handKeyPress", function () {
      if (event.key === 'Enter') {
        _this.searchArtist();
      }
    });
...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("h2", null, "Music Search Engine"), _react.default.createElement(_Search.default, {
        searchArtist: this.searchArtist
      }), _react.default.createElement(_Artist.default, {
        artist: this.state.artist
      }), _react.default.createElement("hr", null), _react.default.createElement(_Tracks.default, {
